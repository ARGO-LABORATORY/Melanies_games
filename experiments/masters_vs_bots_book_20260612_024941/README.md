...
from **14 different balanced opening positions** (from `openings_book.json`), **each played
...
**MASTERS 9 — 14 BOTS**  (draws: 4, games: 27)
...
| Queen's Gambit Accepted | 1/2-1/2 (draw) | — | +32 |
